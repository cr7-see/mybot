...
# 1. أمر سلاش لتفعيل العضو بالتاق: /verify @العضو
...
# أمر إرسال بنل طلب التفعيل المنفصل
...
bot.run('MTUzMTE4Mzk3NDMzNzNzMg.GqGD80.wS8qpffGMEGVxDcOv9Rw99H29S3ips1ZlqwpI')
